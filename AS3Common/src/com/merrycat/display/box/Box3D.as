package com.merrycat.display.box
{
	...
	public class Box3D extends Sprite
	{
		...
		public var backSrc : DisplayObject;
		public var bottomSrc : DisplayObject;
		public var frontSrc : DisplayObject;
		public var leftSrc : DisplayObject;
		public var rightSrc : DisplayObject;
		public var topSrc : DisplayObject;
		...
		public function Box3D(backSrc : DisplayObject, bottomSrc : DisplayObject, frontSrc : DisplayObject, leftSrc : DisplayObject, rightSrc : DisplayObject, topSrc : DisplayObject)
		{
			...
			var localRect : Rectangle = backSrc.getBounds(backSrc);
